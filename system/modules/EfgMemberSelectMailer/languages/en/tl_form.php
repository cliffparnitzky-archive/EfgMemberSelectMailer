...
$GLOBALS['TL_LANG']['tl_form']['efgMemberSelectMailerMemberFormField']          = array('Form field for members selection', 'Please select the form field, which provides the member selection.<br/><b>IMPORTANT:</b> The field must be of type <i>"' . $GLOBALS['TL_LANG']['FFL']['efgMemberSelect'][0] . '"</i>.');
